...
#Reading in the steam genres set
steam_genres = read_csv("./data/genres.csv")

#Joining the raw game.csv to the steamspy 
steam_game_data=left_join(steam_game_data,steamspy_data, by = "app_id")
#Selecting the relevant columns
steam_game_data=steam_game_data|>
  select(app_id,name,owners_range,genres)


# Joining the genre data 
test_steam_game_data = left_join(steam_game_data,steam_genres,by="app_id")
test_full_game_data = left_join(playmydata_pc_data,test_steam_game_data,by="name")

#Removing NA values
test_full_game_data = test_full_game_data|> filter(!is.na(app_id))
#Selecting required columns:
test_full_game_data=test_full_game_data|>
  select(app_id,name,categories,tags,owners_range,genres,genres.y)
